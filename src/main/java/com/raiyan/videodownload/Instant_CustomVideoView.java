...
public class Instant_CustomVideoView extends TextureView implements TextureView.SurfaceTextureListener {
    ...
    private static final String TAG = Instant_CustomVideoView.class.getSimpleName();
    ...
    public void startVideo() {
        if (!isPaused && _act!=null && !_act.isFinishing() && mSource!=null && !mSource.toString().isEmpty()) {
            Log.d(TAG, "startVideo: check called");
...
//                        Log.d("k9looper", "isMainThread prepare on start: "+(Looper.myLooper() == Looper.getMainLooper()));
                        ...
                        Log.d(TAG, "startVideo: check data source: "+mSource);
    ...
    protected void releaseMediaPlayer(){
        Log.d(TAG, "releaseMediaPlayer: check called");
